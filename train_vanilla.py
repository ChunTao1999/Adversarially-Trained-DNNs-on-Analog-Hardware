...
if __name__=='__main__':
    ...
    save_path = os.path.join(args.logdir, '{}-{}w{}'.format('clean', args.arch, args.inflate))
    ...
    for epoch in range(args.start_epoch+1, args.epochs+1):
        ...
        [val_loss, valacc] = validate(valloader, model, criterion, clean_attacker, model, args.print_freq, args.limit_test, args.debug)
        [test_loss, testacc] = validate(testloader, model, criterion, clean_attacker, model, args.print_freq, args.limit_test, args.debug)
        ...
        logging.info(' * Best Model Train Prec@1 {}'.format(best_train_acc))
        logging.info(' * Best Model Val   Prec@1 {}'.format(best_val_acc))
        logging.info(' * Best Model Test  Prec@1 {}'.format(best_test_acc))        
