...
import resnet10_new_interlc_conv312_conv322
...
if __name__=='__main__':
    ...
    if args.arch == 'resnet20':
        ...
        pretrained_model = resnet10_new_interlc_conv312_conv322.Model(args)
    else: 
    ...
    if os.path.exists(os.path.join(save_path, 'conv312_conv322.csv'.format(args.batch_size*args.limit_test))):
        os.remove(os.path.join(save_path, 'conv312_conv322.csv'.format(args.batch_size*args.limit_test)))
        print("Old File conv312_conv322.csv Removed")

    else:
        print("The file did not exist before")

    np.savetxt(os.path.join(save_path, 'conv312_conv322.csv'.format(args.batch_size*args.limit_test)), interlc, delimiter = ',')
    print("New file conv312_conv322.csv saved")

    print(args.pretrained)
    print("conv312_conv322")
