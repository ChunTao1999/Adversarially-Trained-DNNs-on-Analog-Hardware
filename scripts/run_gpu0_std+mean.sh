g=0 #gpu card #
b1=512 #batch size, 128 for w4, 512 for w1
b2=128
l1=100 #limit test
l2=500
i1=1 #inflate
...
#Mean Paths
pt_mean0='./log/cifar10/clean-resnet10w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean1='./log/cifar10/pgd-linf-eps2iter50-resnet10w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean2='./log/cifar10/pgd-linf-eps4iter50-resnet10w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean3='./log/cifar10/pgd-linf-eps6iter50-resnet10w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean4='./log/cifar10/pgd-linf-eps8iter50-resnet10w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean00='./log/cifar10/clean-resnet10w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean11='./log/cifar10/pgd-linf-eps2iter50-resnet10w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean22='./log/cifar10/pgd-linf-eps4iter50-resnet10w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean33='./log/cifar10/pgd-linf-eps6iter50-resnet10w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean44='./log/cifar10/pgd-linf-eps8iter50-resnet10w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean000='./log/cifar100/clean-resnet20w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean111='./log/cifar100/pgd-linf-eps2iter50-resnet20w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean222='./log/cifar100/pgd-linf-eps4iter50-resnet20w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean333='./log/cifar100/pgd-linf-eps6iter50-resnet20w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean444='./log/cifar100/pgd-linf-eps8iter50-resnet20w1/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean0000='./log/cifar100/clean-resnet20w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean1111='./log/cifar100/pgd-linf-eps2iter50-resnet20w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean2222='./log/cifar100/pgd-linf-eps4iter50-resnet20w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean3333='./log/cifar100/pgd-linf-eps6iter50-resnet20w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'
pt_mean4444='./log/cifar100/pgd-linf-eps8iter50-resnet20w4/clean/digital_vs_64x64_100k_findstd/dig_vs_mvm_mean_N1000.npy'


mvm_stddev='64x64_100k'

eps1=2 #attack epsilon
eps2=4

# No attack
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt0 --batch-size $b1 --sigma-path $pt_sigma0 --mean-path $pt_mean0 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt1 --batch-size $b1 --sigma-path $pt_sigma1 --mean-path $pt_mean1 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt2 --batch-size $b1 --sigma-path $pt_sigma2 --mean-path $pt_mean2 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt3 --batch-size $b1 --sigma-path $pt_sigma3 --mean-path $pt_mean3 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt4 --batch-size $b1 --sigma-path $pt_sigma4 --mean-path $pt_mean4 --mvm-std $mvm_stddev

CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt00 --batch-size $b2 --sigma-path $pt_sigma00 --mean-path $pt_mean00 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt11 --batch-size $b2 --sigma-path $pt_sigma11 --mean-path $pt_mean11 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt22 --batch-size $b2 --sigma-path $pt_sigma22 --mean-path $pt_mean22 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt33 --batch-size $b2 --sigma-path $pt_sigma33 --mean-path $pt_mean33 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt44 --batch-size $b2 --sigma-path $pt_sigma44 --mean-path $pt_mean44 --mvm-std $mvm_stddev

CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt000 --batch-size $b1 --sigma-path $pt_sigma000 --mean-path $pt_mean000 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt111 --batch-size $b1 --sigma-path $pt_sigma111 --mean-path $pt_mean111 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt222 --batch-size $b1 --sigma-path $pt_sigma222 --mean-path $pt_mean222 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt333 --batch-size $b1 --sigma-path $pt_sigma333 --mean-path $pt_mean333 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection_std+mean.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt444 --batch-size $b1 --sigma-path $pt_sigma444 --mean-path $pt_mean444 --mvm-std $mvm_stddev
