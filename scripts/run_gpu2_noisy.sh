...
mvm2='64x64_100k'
pt0='./log/cifar10/pgd-linf-eps4iter50-resnet10w1/' #pretrained directory 0
pt1='./log/cifar10/pgd-linf-eps4iter50-resnet10w4/' #pretrained directory 1
pt2='./log/cifar100/pgd-linf-eps4iter50-resnet20w1/' #pretrained directory 2
pt3='./log/cifar100/pgd-linf-eps4iter50-resnet20w4/' #pretrained directory 3
pt4='./log/cifar100/pgd-linf-eps8iter50-resnet20w1/' #pretrained directory 4
...
CUDA_VISIBLE_DEVICES=$g python compare_act_mvmstd_mean.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt4 --store-act $True --mvm $True --mvm-type $mvm2 --batch-size $b1 --limit-test $l1
