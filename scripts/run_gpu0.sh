...
# No attack
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt0 --batch-size $b1 --sigma-path $pt_sigma0 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt1 --batch-size $b1 --sigma-path $pt_sigma1 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt2 --batch-size $b1 --sigma-path $pt_sigma2 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt3 --batch-size $b1 --sigma-path $pt_sigma3 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i1 --pretrained $pt4 --batch-size $b1 --sigma-path $pt_sigma4 --mvm-std $mvm_stddev

CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt00 --batch-size $b2 --sigma-path $pt_sigma00 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt11 --batch-size $b2 --sigma-path $pt_sigma11 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt22 --batch-size $b2 --sigma-path $pt_sigma22 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt33 --batch-size $b2 --sigma-path $pt_sigma33 --mvm-std $mvm_stddev
CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c1 --arch $a1 --inflate $i2 --pretrained $pt44 --batch-size $b2 --sigma-path $pt_sigma44 --mvm-std $mvm_stddev

#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt000 --batch-size $b1 --sigma-path $pt_sigma000 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt111 --batch-size $b1 --sigma-path $pt_sigma111 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt222 --batch-size $b1 --sigma-path $pt_sigma222 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt333 --batch-size $b1 --sigma-path $pt_sigma333 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i1 --pretrained $pt444 --batch-size $b1 --sigma-path $pt_sigma444 --mvm-std $mvm_stddev
#
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i2 --pretrained $pt0000 --batch-size $b2 --sigma-path $pt_sigma0000 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i2 --pretrained $pt1111 --batch-size $b2 --sigma-path $pt_sigma1111 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i2 --pretrained $pt2222 --batch-size $b2 --sigma-path $pt_sigma2222 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i2 --pretrained $pt3333 --batch-size $b2 --sigma-path $pt_sigma3333 --mvm-std $mvm_stddev
#CUDA_VISIBLE_DEVICES=$g python evaluate_noise_injection.py --dataset $c2 --arch $a2 --inflate $i2 --pretrained $pt4444 --batch-size $b2 --sigma-path $pt_sigma4444 --mvm-std $mvm_stddev
