...
if __name__=='__main__':
    ...
    if args.arch == 'resnet20':
        ...
        model_eval = resnet20_cifar_noisy.Model_NoisetoEveryConv(args)
    elif args.arch == 'resnet10':
        args.classes = 10
        pretrained_model = resnet10_cifar.Model(args)
        model_eval = resnet10_cifar_noisy.Model_NoisetoEveryConv(args)
    else:
    ...
    if args.mvm:
        ...
        save_path = os.path.join(args.pretrained, 'WB-attacks', "test_noise_to_every_conv_{}".format(args.mvm_std))
    model_eval.cuda()
    model_eval.eval()
