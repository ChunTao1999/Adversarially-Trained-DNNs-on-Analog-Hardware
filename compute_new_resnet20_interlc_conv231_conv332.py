...
import resnet20_new_interlc_conv231_conv332
...
if __name__=='__main__':
    ...
    if args.arch == 'resnet20':
        pretrained_model = resnet20_new_interlc_conv231_conv332.Model(args)
    ...
    if os.path.exists(os.path.join(save_path, 'conv231_conv332.csv'.format(args.batch_size*args.limit_test))):
        os.remove(os.path.join(save_path, 'conv231_conv332.csv'.format(args.batch_size*args.limit_test)))
        print("Old File conv231_conv332.csv Removed")

    else:
        print("The file did not exist before")

    np.savetxt(os.path.join(save_path, 'conv231_conv332.csv'.format(args.batch_size*args.limit_test)), interlc, delimiter = ',')
    print("New file conv231_conv332.csv saved")

    print(args.pretrained)
    print("conv231_conv332")
