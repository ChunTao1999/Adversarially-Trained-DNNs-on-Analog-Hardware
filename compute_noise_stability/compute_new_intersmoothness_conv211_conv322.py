...
import resnet10_new_intersmoothness_conv211_conv322
...
if __name__=='__main__':
    ...
    np.savetxt(os.path.join(save_path, 'conv211_conv322.csv'.format(args.batch_size*args.limit_test)), intersmoothness, delimiter = ',')
