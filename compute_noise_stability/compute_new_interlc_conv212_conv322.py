...
import resnet10_new_interlc_conv212_conv322
...
if __name__=='__main__':
    ...
    if os.path.exists(os.path.join(save_path, 'conv212_conv322.csv'.format(args.batch_size*args.limit_test))):
        os.remove(os.path.join(save_path, 'conv212_conv322.csv'.format(args.batch_size*args.limit_test)))
        print("Old File conv212_conv322.csv Removed")

    else:
        print("The file did not exist before")

    np.savetxt(os.path.join(save_path, 'conv212_conv322.csv'.format(args.batch_size*args.limit_test)), interlc, delimiter = ',')
    print("New file conv212_conv322.csv saved")

    print(args.pretrained)
    print("conv212_conv322")
