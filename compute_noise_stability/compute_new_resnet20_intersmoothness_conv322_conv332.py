...
import resnet20_new_intersmoothness_conv322_conv332
...
if __name__=='__main__':
    ...
    if args.arch == 'resnet20':
        pretrained_model = resnet20_new_intersmoothness_conv322_conv332.Model(args)
    ...
    np.savetxt(os.path.join(save_path, 'conv322_conv332.csv'.format(args.batch_size*args.limit_test)), intersmoothness, delimiter = ',')
