...
import resnet10_new_intersmoothness_conv321_conv322
...
if __name__=='__main__':
    ...
    if args.arch == 'resnet20':
        ...
        pretrained_model = resnet10_new_intersmoothness_conv321_conv322.Model(args)
    else: 
    ...
    np.savetxt(os.path.join(save_path, 'conv321_conv322.csv'.format(args.batch_size*args.limit_test)), intersmoothness, delimiter = ',')
